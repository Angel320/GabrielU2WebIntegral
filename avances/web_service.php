...
<br>
 <section>
    <center><h1>¿Desea extraer informacion de los usuarios?</h1></center>
 </section>
...
<body>
                ...
                <div class="col">
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            ...
                            <th class="sort asc">Compras Hechas</th>
                        </thead>
    ...
    <section>   
        <h1>USAR API</h1>
        <a href="https://web.postman.co/">
        <button type="button" class="btn btn-info">Clic Aqui</button>
         </a> 
    </section>
    </center>   
    ...
    <script>
        ...
        function getData() {
            ...
            let num_registros = document.getElementById("id").value
